  ...
  if (authNavContainer && isAuthenticated()) {
    ...
    authNavContainer.innerHTML = `
      ...
      <div class="flex items-center gap-3">
        <div class="flex items-center gap-2 bg-on-primary/10 px-3 py-1.5 rounded-md border border-on-primary/20">
          ...
          <div class="flex flex-col text-left">
            ...
            <span class="text-on-primary/70 text-[10px] uppercase font-bold tracking-wider">${role}</span>
          </div>
        </div>
